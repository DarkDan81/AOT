...
Использованы 150 сообщений RuSentiment [1]. Основной репозиторий больше не распространяет корпус, поэтому данные получены из публичного форка strawberrypie/rusentiment. Ссылка, контрольная сумма исходного файла и процедура отбора сохранены. Выборка взята из обучающей части общей подготовки с random_state=42; оставлены positive, negative и neutral. Классы speech и skip исключены. Это трёхклассовый учебный срез, а не воспроизведение исходной пяти-классовой задачи статьи.
