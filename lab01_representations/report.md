...
В сохранённом CSV поле reviewer указывает, что исходные семантические суждения подготовлены ИИ-ассистентом. Личная ручная проверка девяти пар, требуемая заданием, этими записями не подтверждается.
