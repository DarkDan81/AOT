...
Университет ИТМО, группа К3341. ЛР1, ЛР3 и ЛР4: Дущенко Даниил Александрович. ЛР2, ЛР5 и ЛР6: Дущенко Даниил Александрович и Коваленко Евгений Юрьевич. Преподаватель: Гусарова Наталия Федоровна. Санкт-Петербург, 2026.
...
В шести работах сравниваются методы на сохранённых экспериментальных данных. Использование моделей, источники корпусов и ограничения оценки описаны в методике каждой работы. В ЛР2 сравниваются три изолированные модельные разметки A/B/C; они не обозначают трёх авторов отчёта. В ЛР6 журнал AI_LOG фиксирует предусмотренную заданием разработку в режиме vibe coding. Метрики и первичные результаты сохраняются без изменений при редактировании отчётов.
