...
1. Построить baseline наиболее частого класса.
2. Обучить TF–IDF с n-граммами 1–2 и LogisticRegression; изменять не более двух гиперпараметров на validation.
3. Реализовать zero-shot одной LLM с JSON-полем label.
4. Реализовать few-shot той же модели с шестью примерами, по два каждого класса.
5. Оценить четыре режима на test и синтетическом стресс-наборе.
6. Измерить время, входные и выходные токены, оценить стоимость обработки.
7. Разобрать 15 случаев: пять ошибок классики, пять LLM и пять расхождений.
8. Сформулировать рекомендации для массовой, сложной и локальной обработки.
...
## Задание 1 и 2. Baseline и классический классификатор
...
## Задание 3 и 4. Zero-shot и few-shot
...
## Задание 5 и 6. Качество, время и стоимость
...
## Задание 7. Анализ пятнадцати случаев
...
## Задание 8. Рекомендации по применению
...
На test few-shot получил macro F1 0,659 против 0,543 у TF–IDF с логистической регрессией, однако классический метод дал более высокую accuracy: 0,696 против 0,670. На синтетическом stress оба LLM-режима достигли accuracy 0,900. Классический метод значительно быстрее; выбор решения зависит от требований к задержке и качества на разных классах. Few-shot улучшил результат относительно zero-shot на test, но преимущество не следует переносить на другие данные без проверки.
